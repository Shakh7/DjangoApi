...
class Lead(models.Model):
    car_make = models.ForeignKey(Car, on_delete=models.CASCADE, related_name='leads')
    car_model = models.ForeignKey(CarModel, on_delete=models.CASCADE)
    car_year = models.IntegerField(max_length=4, validators=[MinValueValidator(1900), MaxValueValidator(2100)])
    pick_up_address = models.ForeignKey(City, on_delete=models.CASCADE, related_name='pick_up_leads')
    drop_off_address = models.ForeignKey(City, on_delete=models.CASCADE, related_name='drop_off_leads')
    ...
    clients = models.ManyToManyField(CustomUser, blank=True, null=True)
